...
.PHONY: all housekeeping_robot ac_robot BoAT-SupportLayer_obj cleanBoAT-SupportLayer BoAT-Engine_obj cleanBoAT-Engine clean_housekeeping_robot clean_ac_robot
all: housekeeping_robot ac_robot


housekeeping_robot: createdir SupportLayer_obj Engine_obj
	make -C $(BOAT_BASE_DIR)/housekeeping_robot all

ac_robot: createdir SupportLayer_obj Engine_obj
	make -C $(BOAT_BASE_DIR)/ac_robot all
...
clean: cleanBoAT-SupportLayer cleanBoAT-Engine clean_housekeeping_robot clean_ac_robot
...
clean_housekeeping_robot:
	make -C $(BOAT_BASE_DIR)/housekeeping_robot clean

clean_ac_robot:
	make -C $(BOAT_BASE_DIR)/ac_robot clean
